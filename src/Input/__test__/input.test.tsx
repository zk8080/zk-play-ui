 ...
 * @LastEditTime: 2021-08-23 22:35:52
...
describe('test Input component', () => {
  it('should render the correct default Input', () => {
    ...
    expect(wrapper.find('input').hasClass('viking-input-inner')).toBeTruthy();
  ...
  it('should render the disabled Input on disabled property', () => {
    ...
    expect(
      wrapper.find('.viking-input-wrapper').hasClass('is-disabled'),
    ).toBeTruthy();
  });
  it('should render different input sizes on size property', () => {
    const wrapper = shallow(<Input placeholder="sizes" size="lg" />);
    expect(
      wrapper.find('.viking-input-wrapper').hasClass('input-size-lg'),
    ).toBeTruthy();
  });
  it('should render prepand and append element on prepand/append property', () => {
    ...
    expect(
      wrapper
        .find('.viking-input-wrapper')
        .hasClass('input-group input-group-append input-group-prepend'),
    ).toBeTruthy();
    expect(wrapper.find('.viking-input-group-prepend').text()).toEqual(
      'https://',
    );
    expect(wrapper.find('.viking-input-group-append').text()).toEqual('.com');
  });
});
